...
jib {
    to {
        image = "rg.nl-ams.scw.cloud/dreamexposure/b4tea4t"
        tags = mutableSetOf("latest", buildVersion)
    }

    from.image = "eclipse-temurin:21-jre-alpine@sha256:8cc1202a100e72f6e91bf05ab274b373a5def789ab6d9e3e293a61236662ac27"
}

gitProperties {
    extProperty = "gitPropertiesExt"

    customProperty("bot.version", buildVersion)
    customProperty("bot.version.d4j", d4jVersion)
}
...
tasks {
    generateGitProperties {
        doLast {
            ...
            val enumFile = FileSpec.builder("pet.pupgrammer.4tea4t", "GitProperty")
                .addType(
